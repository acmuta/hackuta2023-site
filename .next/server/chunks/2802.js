...
const validator = __webpack_require__(7134);
const parse = __webpack_require__(54011);
const redactor = __webpack_require__(15862);
const restorer = __webpack_require__(7584);
const { groupRedact , nestedRedact  } = __webpack_require__(77334);
const state = __webpack_require__(33407);
const rx = __webpack_require__(6416);
...
function nestedRestore(arr) {
    ...
    for(var i = 0; i < length; i++){
        ...
        /* istanbul ignore else */ if (typeof target === "object") {
...
const { groupRestore , nestedRestore  } = __webpack_require__(77334);
...
const { version  } = __webpack_require__(45088);
...
const { wait  } = __webpack_require__(84317);
const { WRITE_INDEX , READ_INDEX  } = __webpack_require__(56196);
...
if (!globalThis.ReadableStream) {
    ...
    try {
        ...
        Object.assign(globalThis, __webpack_require__(54769));
    }
}
try {
...
const errSerializer = __webpack_require__(28494);
const reqSerializers = __webpack_require__(69013);
const resSerializers = __webpack_require__(25164);
module.exports = {
    err: errSerializer,
...
const { messageWithCauses , stackWithCauses , isErrorLike  } = __webpack_require__(32199);
...
/* eslint no-prototype-builtins: 0 */ const { lsCacheSym , levelValSym , useOnlyCustomLevelsSym , streamSym , formattersSym , hooksSym  } = __webpack_require__(34213);
const { noop , genLog  } = __webpack_require__(19970);
const levels = {
    trace: 10,
    debug: 20,
    info: 30,
...
const { levels  } = __webpack_require__(99370);
...
/* eslint no-prototype-builtins: 0 */ const { EventEmitter  } = __webpack_require__(82361);
const { lsCacheSym , levelValSym , setLevelSym , getLevelSym , chindingsSym , parsedChindingsSym , mixinSym , asJsonSym , writeSym , mixinMergeStrategySym , timeSym , timeSliceIndexSym , streamSym , serializersSym , formattersSym , errorKeySym , useOnlyCustomLevelsSym , needsMetadataGsym , redactFmtSym , stringifySym , formatOptsSym , stringifiersSym , msgPrefixSym  } = __webpack_require__(34213);
const { getLevel , setLevel , isLevelEnabled , mappings , initialLsCache , genLsCache , assertNoLevelCollisions  } = __webpack_require__(99370);
const { asChindings , asJson , buildFormatters , stringify  } = __webpack_require__(19970);
const { version  } = __webpack_require__(32351);
const redaction = __webpack_require__(27670);
...
const fastRedact = __webpack_require__(77755);
const { redactFmtSym , wildcardFirstSym  } = __webpack_require__(34213);
...
/* eslint no-prototype-builtins: 0 */ const format = __webpack_require__(21992);
const { mapHttpRequest , mapHttpResponse  } = __webpack_require__(96652);
const SonicBoom = __webpack_require__(34926);
const onExit = __webpack_require__(81321);
const { lsCacheSym , chindingsSym , writeSym , serializersSym , formatOptsSym , endSym , stringifiersSym , stringifySym , stringifySafeSym , wildcardFirstSym , nestedKeySym , formattersSym , messageKeySym , errorKeySym , nestedKeyStrSym , msgPrefixSym  } = __webpack_require__(34213);
const { isMainThread  } = __webpack_require__(71267);
const transport = __webpack_require__(64653);
function noop() {}
...
const getCallers = __webpack_require__(49851);
const { join , isAbsolute  } = __webpack_require__(71017);
const sleep = __webpack_require__(91849);
const onExit = __webpack_require__(81321);
const ThreadStream = __webpack_require__(90352);
...
/* eslint no-prototype-builtins: 0 */ const os = __webpack_require__(22037);
const stdSerializers = __webpack_require__(96652);
const caller = __webpack_require__(49851);
const redaction = __webpack_require__(27670);
const time = __webpack_require__(59743);
const proto = __webpack_require__(81478);
const symbols = __webpack_require__(34213);
const { configure  } = __webpack_require__(63930);
const { assertDefaultLevelFound , mappings , genLsCache , levels  } = __webpack_require__(99370);
const { createArgsNormalizer , asChindings , buildSafeSonicBoom , buildFormatters , stringify , normalizeDestFileDescriptor , noop  } = __webpack_require__(19970);
const { version  } = __webpack_require__(32351);
const { chindingsSym , redactFmtSym , serializersSym , timeSym , timeSliceIndexSym , streamSym , stringifySym , stringifySafeSym , stringifiersSym , setLevelSym , endSym , formatOptsSym , messageKeySym , errorKeySym , nestedKeySym , mixinSym , useOnlyCustomLevelsSym , formattersSym , hooksSym , nestedKeyStrSym , mixinMergeStrategySym , msgPrefixSym  } = symbols;
...
function pino(...args) {
    ...
    const { redact , crlf , serializers , timestamp , messageKey , errorKey , nestedKey , base , name , level , customLevels , mixin , mixinMergeStrategy , useOnlyCustomLevels , formatters , hooks , depthLimit , edgeLimit , onChild , msgPrefix  } = opts;
...
module.exports.transport = __webpack_require__(64653);
module.exports.multistream = __webpack_require__(23300);
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38642);
...
/* harmony import */ var node_domexception__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57309);
/* harmony import */ var _file_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59185);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(38642);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48116);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38642);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(59185);
...
var fetch_blob = __webpack_require__(38642);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __webpack_require__(15058);
 ...
 */ class Body {
    ...
    async formData() {
        ...
        const { toFormData  } = await __webpack_require__.e(/* import() */ 4152).then(__webpack_require__.bind(__webpack_require__, 34152));
...
var from = __webpack_require__(36498);
