...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(76370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 16997)), "/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/(pages)/admin/teams/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 37408)), "/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/error.tsx"],
    ...
    const pages = ["/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/(pages)/admin/teams/page.tsx"];
...
;// CONCATENATED MODULE: ./src/lib/db/helpers.ts
...
async function getDiscordIdOf(user) {
    const client = await db/* default */.Z;
    return (await client.db().collection("accounts").findOne({
        provider: "discord",
        userId: user
    }))?.providerAccountId;
}

// EXTERNAL MODULE: ./src/lib/db/models/Team.ts
var Team = __webpack_require__(99756);
// EXTERNAL MODULE: ./src/lib/db/models/User.ts + 2 modules
var User = __webpack_require__(65179);
;// CONCATENATED MODULE: ./src/app/(pages)/admin/teams/page.tsx
...
async function Teams() {
    const teams = await (0,Team/* getResolvedTeams */.O8)();
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* Box */.x, {
        ...
        children: [
            ...
            teams.length ? undefined : /*#__PURE__*/ jsx_runtime.jsx("div", {
                children: "No teams available."
            }),
            ...await Promise.all(teams.map(async (team)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)("section", {
                    children: [
                        /*#__PURE__*/ jsx_runtime.jsx("h3", {
                            children: team.name
                        }),
                        /*#__PURE__*/ jsx_runtime.jsx("table", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("tr", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ jsx_runtime.jsx("th", {
                                                children: "Discord ID (paste into Discord to see who it is)"
                                            })
                                        ]
                                    }),
                                    await Promise.all(team.memberUsers.map(async (user)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)("tr", {
                                            children: [
                                                /*#__PURE__*/ jsx_runtime.jsx("td", {
                                                    children: (0,User/* getFullName */.Pp)(user)
                                                }),
                                                /*#__PURE__*/ jsx_runtime.jsx("td", {
                                                    children: user.email
                                                }),
...
var __webpack_exports__ = __webpack_require__.X(0, [2802,3561,2869,4617,9033,4942,8051,8704,8303,7828,6437,2167], () => (__webpack_exec__(15653)));
