...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(76370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47955)), "/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 64180)), "/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/layout.tsx"],
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 37408)), "/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/error.tsx"],
          
        }
      ]
      }.children;
    const pages = ["/home/runner/work/hackuta2023-site/hackuta2023-site/src/app/page.tsx"];
...
__webpack_require__.d(__webpack_exports__, {
  "ApplicationForm": () => (/* binding */ ApplicationForm)
});
...
const CountrySchema = lib/* default.enum */.ZP["enum"](Object.values(countries_namespaceObject));
/**
 ...
 */ const sortUniversity = (a, b)=>{
    ...
    const normalize = (s)=>s.toLowerCase().startsWith("the ") ? s.slice(4) : s;
    const [loveForA, loveForB] = [
        Loves.get(a),
        Loves.get(b)
    ];
...
const KnownUniversitySchema = lib/* default.enum */.ZP["enum"](universities_namespaceObject.sort(sortUniversity));
const TShirtSizeSchema = lib/* default.enum */.ZP["enum"]([
    "S",
    "M",
    "L",
    "XL"
]);
const KnownDietaryRestrictionSchema = lib/* default.enum */.ZP["enum"]([
    "Allergies",
    "Celiac Disease",
    "Halal",
    "Kosher",
...
const KnownGenderSchema = lib/* default.enum */.ZP["enum"]([
    "Man",
    "Woman",
    "Non-Binary",
    "Prefer Not to Answer"
]);
const KnownPronounsSchema = lib/* default.enum */.ZP["enum"]([
    "She/Her",
    "He/Him",
    "They/Them",
    "Prefer Not to Answer"
]);
const KnownRaceEthnicitySchema = lib/* default.enum */.ZP["enum"]([
    "Asian Indian",
    "Black or African",
    "Chinese",
    "Filipino",
...
const TernarySchema = lib/* default.enum */.ZP["enum"]([
    "Yes",
    "No",
    "Unsure"
]);
const KnownSexualitySchema = lib/* default.enum */.ZP["enum"]([
...
const KnownMajorSchema = lib/* default.enum */.ZP["enum"]([
 ...
 */ const ApplicationSchema = lib/* default.object */.ZP.object({
    firstName: lib/* default.string */.ZP.string().nonempty(),
    lastName: lib/* default.string */.ZP.string().nonempty(),
    age: lib/* default.number */.ZP.number().int().gte(1).lte(127),
    phoneNumber: lib/* default.string */.ZP.string().refine((validator_default()).isMobilePhone),
    school: KnownUniversitySchema.or(lib/* default.string */.ZP.string().nonempty()),
    levelOfStudy: LevelOfStudySchema,
    countryOfResidence: CountrySchema,
    tShirtSize: TShirtSizeSchema,
    dietaryRestriction: KnownDietaryRestrictionSchema.or(lib/* default.string */.ZP.string().nonempty()).array(),
    // Demographic information.
    underrepresentedGroup: TernarySchema.optional(),
    gender: KnownGenderSchema.or(lib/* default.string */.ZP.string()).optional(),
    pronouns: KnownPronounsSchema.or(lib/* default.string */.ZP.string().nonempty()).array().optional(),
    raceEthnicity: KnownRaceEthnicitySchema.or(lib/* default.string */.ZP.string().nonempty()).array().optional(),
    sexuality: KnownSexualitySchema.or(lib/* default.string */.ZP.string()).optional(),
    highestLevelOfEducation: LevelOfStudySchema.optional(),
    fieldOfStudy: KnownMajorSchema.or(lib/* default.string */.ZP.string().nonempty()).array().optional()
});
...
// EXTERNAL MODULE: ./src/components/ApplicationForm/styles.module.css
var styles_module = __webpack_require__(55447);
var styles_module_default = /*#__PURE__*/__webpack_require__.n(styles_module);
;// CONCATENATED MODULE: ./src/components/ApplicationForm/index.tsx
...
function ApplicationForm() {
    const [formErrors, setFormMessages] = (0,react_.useState)([]);
    ...
    async function submit() {
        ...
        formData.forEach((v, k)=>{
            ...
            const zodFieldType = ApplicationSchema.shape[k];
            const typeName = zodFieldType._def.typeName === "ZodOptional" ? zodFieldType._def.innerType._def.typeName : zodFieldType._def.typeName;
            if (typeName === "ZodArray") {
                (jsonData[k] ??= []).push(v.toString());
        ...
        if (validateResult.success) {
            ...
            setErrors({});
            try {
                await (0,shared/* fetchPost */.SD)("/api/apply", JSON.stringify(jsonData));
            } catch (e) {
                setFormMessages([
                    "Submission failed",
                    (0,client/* stringifyError */.n)(e)
                ]);
            }
        } else {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Box/* Box */.x, {
        ...
        direction: "column",
        gap: "1rem",
        className: (styles_module_default()).applicationForm,
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                id: "age",
                text: "Age",
                errors: errors["age"],
                selectProps: {
                ...
                options: (0,client/* range */.w6)(13, 128).map(shared/* toOption */.Er)
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* TextInput */.oi, {
                id: "phoneNumber",
                text: "Phone Number",
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownUniversitySchema),
                isCreatable: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                id: "levelOfStudy",
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(LevelOfStudySchema)
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(CountrySchema)
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                id: "tShirtSize",
                text: "T-Shirt Size",
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(TShirtSizeSchema)
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownDietaryRestrictionSchema),
                isClearable: true,
                isCreatable: true,
                isMulti: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Heading/* Heading */.X, {
                level: 3,
                children: "Optional Demographic Information"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(TernarySchema),
                isClearable: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                id: "gender",
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownGenderSchema),
                isClearable: true,
                isCreatable: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownPronounsSchema),
                isClearable: true,
                isCreatable: true,
                isMulti: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownRaceEthnicitySchema),
                isClearable: true,
                isCreatable: true,
                isMulti: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownSexualitySchema),
                isClearable: true,
                isCreatable: true
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(Form/* Dropdown */.Lt, {
                ...
                options: (0,shared/* zodEnumToOptions */.ho)(KnownMajorSchema),
                isClearable: true,
                isCreatable: true,
                isMulti: true
            }),
            formErrors.length ? /*#__PURE__*/ jsx_runtime_.jsx(ErrorMessage/* default */.Z, {
                errors: formErrors
            }) : undefined,
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 64483));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 30641));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 43939))
...
// Exports
module.exports = {
	"cardLink": "Card_cardLink__B8A3x",
	"card": "Card_card__MaeNq",
	"blue": "Card_blue__6SXiZ",
	"green": "Card_green__zCy37",
	"red": "Card_red__QPBKE",
	"yellow": "Card_yellow__zR0ap",
	"white": "Card_white__Hyfsw"
};
...
module.exports = {
	...
	"heroText": "page_heroText__2NqOx",
	"heading2": "page_heading2__1lKDb",
	"heroHeading": "page_heroHeading__4is2k",
	"fitParentWidth": "page_fitParentWidth__ra4t4",
	"text": "page_text__sneHE",
	"gradientContainer": "page_gradientContainer__riIya",
	"about": "page_about__VL9KY",
	"sectionContainer": "page_sectionContainer__KcsGa",
	"socials": "page_socials__zv1vr",
	"sponsorLogoBox": "page_sponsorLogoBox__kHW7H",
	"donation-container": "page_donation-container__hEDP_",
	"sectionIndent": "page_sectionIndent__qSe4E",
	"cardContainer": "page_cardContainer__SvCfo",
	"applicationForm": "page_applicationForm__Nggkj",
	"dashboardContent": "page_dashboardContent__0UD4f"
};
...
// Exports
module.exports = {
	"applicationForm": "styles_applicationForm__bzB5G"
};
...
const proxy = (0,module_proxy.createProxy)("/home/runner/work/hackuta2023-site/hackuta2023-site/src/components/ApplicationForm/index.tsx")
...
/* harmony default export */ const ApplicationForm = (proxy.default);

const e0 = proxy["ApplicationForm"];

// EXTERNAL MODULE: ./src/components/Box/index.ts + 1 modules
var components_Box = __webpack_require__(72781);
;// CONCATENATED MODULE: ./src/components/Header/index.tsx

const Header_proxy = (0,module_proxy.createProxy)("/home/runner/work/hackuta2023-site/hackuta2023-site/src/components/Header/index.tsx")
...
/* harmony default export */ const Header = (Header_proxy.default);
...
// EXTERNAL MODULE: ./src/app/(pages)/post/[slug]/PostRenderer.tsx + 2 modules
var PostRenderer = __webpack_require__(4475);
// EXTERNAL MODULE: ./node_modules/next/link.js
var next_link = __webpack_require__(42585);
var link_default = /*#__PURE__*/__webpack_require__.n(next_link);
// EXTERNAL MODULE: ./src/app/Card.module.css
var Card_module = __webpack_require__(21080);
var Card_module_default = /*#__PURE__*/__webpack_require__.n(Card_module);
;// CONCATENATED MODULE: ./src/app/Card.tsx




function Card({ cardStyle , children , href  }) {
    const card = /*#__PURE__*/ jsx_runtime.jsx("div", {
        className: classnames_default()((Card_module_default()).card, (Card_module_default())[cardStyle ?? "blue"]),
        children: children
    });
...
async function Home() {
    ...
    if (user?.application) {
        /* @ts-expect-error Async React Server Component */ return /*#__PURE__*/ jsx_runtime.jsx(Dashboard, {
            user: user
        });
    } else if (user) {
        return /*#__PURE__*/ jsx_runtime.jsx(Apply, {
            user: user
        });
    } else {
        /* @ts-expect-error Async React Server Component */ return /*#__PURE__*/ jsx_runtime.jsx(Landing, {});
    }
}
...
async function Landing() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Box/* Box */.x, {
        direction: "column",
        alignItems: "center",
...
// 	)
// }
const ComingSoon = ()=>/*#__PURE__*/ _jsx(Box, {
        style: {
            paddingLeft: "0.5rem"
        },
...
function Apply({ user  }) {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Box/* Box */.x, {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime.jsx(Header_e0, {
                items: [
                    {
                        link: "/",
                        name: "Apply"
...
async function Dashboard({ user  }) {
    ...
    if (user.checkInPin === undefined) {
        const pin = (0,external_crypto_.randomInt)(100000, 999999);
    ...
    if (user.applicationStatus === "accepted") {
        children = posts.map((post)=>/*#__PURE__*/ jsx_runtime.jsx(Card, {
                cardStyle: post.cardStyle,
                href: post.contentSource ? `/post/${post.slug}` : undefined,
                children: /*#__PURE__*/ jsx_runtime.jsx(PostRenderer/* default */.Z, {
                    post: post,
        ...
        children = [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("p", {
                children: [
                    ...
                    ". Please contact the organizers if you believe this is a mistake."
                ]
            }, "kid")
        ];
    } else {
        children = [
            /*#__PURE__*/ jsx_runtime.jsx("p", {
                children: "We've received your application. Check back later to see if you get accepted, and feel free to contact the organizers if you need any assistance!"
            }, "kid")
        ];
    }
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Box/* Box */.x, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Box/* Box */.x, {
                direction: "column",
                className: classnames_default()("pagePadding"),
                style: {
                    flex: 1
                },
                gap: "1rem",
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime.jsx(components_Box/* Box */.x, {
                        direction: "row",
                        alignItems: "start",
                        wrap: "wrap",
                        className: classnames_default()((page_module_default()).cardContainer),
                        children: [
                            ...children
                        ]
                    })
...
var __webpack_exports__ = __webpack_require__.X(0, [2802,3561,2869,904,5677,7123,1474,9843,3655,9986,4942,8051,8704,8303,7542,946,9076], () => (__webpack_exec__(34219)));
